...
@section('title', 'تعديل باقة - نفسجي للتمكين النفسي')
    ...
    <div class="dashboard-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <h1 class="dashboard-title">تعديل باقة</h1>
                    <p class="dashboard-subtitle">تعديل معلومات الباقة "{{ $package->name ?? '' }}"</p>
                </div>
                <div class="col-lg-6">
                                    ...
                                    <div class="col-md-8">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{ old('slug', $package->slug) }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control @error('discount') is-invalid @enderror" id="discount" name="discount" value="{{ old('discount', $package->discount) }}" min="0" max="100">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control @error('duration') is-invalid @enderror" id="duration" name="duration" value="{{ old('duration', $package->duration) }}" min="1" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <div class="image-upload-container">
                                                <div class="image-preview" id="imagePreview">
                                                    @if($package->image)
                                                        <img src="{{ asset('storage/' . $package->image) }}" alt="{{ $package->name }}" id="previewImage">
                                                    @else
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check form-switch mb-2">
                                                <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" {{ old('is_featured', $package->is_featured) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="is_featured">باقة مميزة</label>
                                            </div>
                                            <div class="form-check form-switch mb-2">
                                                <input class="form-check-input" type="checkbox" id="is_limited" name="is_limited" {{ old('is_limited', $package->is_limited) ? 'checked' : '' }}>
                                                            ...
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="form-check">
                                                                        <input class="form-check-input service-checkbox" type="checkbox" id="service{{ $service->id }}" name="services[]" value="{{ $service->id }}" 
