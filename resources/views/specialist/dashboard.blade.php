            ...
            <div class="space-y-8">
                ...
                <div class="bg-white shadow-lg rounded-lg p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="{{ route('specialist.reviews') }}" class="block text-purple-600 hover:text-purple-800 font-medium"><i class="fas fa-star ml-2"></i>عرض التقييمات</a>
                    </div>
                </div>
                ...
                <div class="bg-white shadow-lg rounded-lg p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="{{ route('specialist.reviews') }}" class="text-sm text-purple-600 hover:text-purple-800 font-medium">عرض الكل</a>
                    </div>
